...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField]
    public Text remarks,levelNo_text;
    ...
    public void OnNextRapWord()
    {
        ...
        popUp_text.text = "" + levels[levelNo].leveldata[rapWordNo].RapString ;
        DummyText.text = "<#161616>" + levels[levelNo].leveldata[rapWordNo].RapString + "</color>";

        MakeColorText(DummyText, levels[levelNo].leveldata[rapWordNo].MarkWord);
    ...
    {
        optionA_text.text = levels[levelNo].leveldata[rapWordNo].OptionA.ToString();
        optionB_text.text = levels[levelNo].leveldata[rapWordNo].OptionB.ToString();
    ...
    {
        int i = levels[levelNo].leveldata[rapWordNo].CorrectAnswer;
    ...
    public void OnReset()
    {
        ...
        if (levels[levelNo].leveldata.Count <= rapWordNo)
        {
            rapWordNo = 0;
