...
public  class LerpObjectLocalPosition : MonoBehaviour
{
    public static LerpObjectLocalPosition instance;
    bool toLerp = false;
    float lerpSpeed;
    float lerpTime;
    ...
    public void LerpLocalObject(Transform lerpObject, Vector3 _finalPos, float speed, System.Action _lerpComplete = null)
    {
